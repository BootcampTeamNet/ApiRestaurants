        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathImage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLatitude = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    LocationLongitude = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TimeMaxCancelBooking = table.Column<int>(type: "int", nullable: true),
                    PathImage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathImage = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CaloriesMinimun = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CaloriesMaximun = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Proteins = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Fats = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Sugars = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
